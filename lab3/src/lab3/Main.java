...
//		VideoPlayer vp2 = new VideoPlayer(new Sound(21),new Screen(7));
//		VideoPlayer vp3 = new VideoPlayer(new Sound(17),new Screen(6.5));
//		VideoPlayer vp4 = new VideoPlayer(new Sound(17),new Screen(6.5));
//		VideoPlayer vp5 = new VideoPlayer(new Sound(24),new Screen(6.5));

		System.out.println(VideoPlayer.Getk());
//		vp1.play();
//		vp2.review();
//		vp3.setIx(6.6);
